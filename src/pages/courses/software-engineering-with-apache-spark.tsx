            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="max-w-xl mt-5 mx-auto text-xl text-gray-dark">
                        Combine the power of Apache Spark with the quality from agile software engineering to transform
                        your user data into
            ...
            <div
                ...
                <div className="lg:col-start-2 lg:pl-8">
                    <div className="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
                        ...
                        <p className="mt-8 text-lg font-medium lg:text-gray-dark lg:font-normal">
                            <span
                                className=" text-red font-semibold">Software Engineering with Apache Spark</span> teaches
                    ...
                    <div className="hidden lg:block lg:flex-shrink-0">
                        <div className="h-64 w-64 rounded-full xl:h-80 xl:w-80 relative">
                            <Image
                                ...
                                alt="Course instructor Neil Chaudhuri"
                            />
                        </div>
                    </div>
                    ...
                    <div className="relative lg:ml-10">
                        ...
                        <blockquote className="relative">
                            <div className="text-2xl leading-9 font-medium text-gray-900">
                                <p>
                                    I have built several Scala and Apache Spark applications currently in production,
                                    and I
