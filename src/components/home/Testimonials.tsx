                            ...
                            <div className="flex items-start">
                                <div className="flex-shrink-0 inline-flex rounded-full border-2 border-white">
                                    <Image
                                        ...
                                        src="/img/testimonials/tindall.jpeg"
                                        alt=""
                                    />
                                </div>
                                <div className="ml-4">
                                    <div className="text-base font-medium text-red dark:text-red-light">Lauren Tindall</div>
                                    <div className="text-base font-medium text-gray-dark dark:text-blue-light">Learning Experience Strategy Lead, Capital One</div>
                                </div>
                            </div>
                        </footer>
                    </blockquote>
                            ...
                            <div className="flex items-start">
                                <div className="flex-shrink-0 inline-flex rounded-full border-2 border-white">
                                    <Image
                                        ...
                                        height={80}
                                        className="inline-block rounded-full"
                                        src="/img/testimonials/zeitlin.jpg"
                                        alt="Michael Zeitlin, Principal, Sikor Software Inc."
                                        quality={50}
                                    />
                                </div>
                                <div className="ml-4">
                                    <div className="text-base font-medium text-red dark:text-red-light">Michael Zeitlin</div>
                                    <div className="text-base font-medium text-gray-dark dark:text-blue-light">Principal, Sikor Software Inc.</div>
                                </div>
                            </div>
                        </footer>
                    </blockquote>
