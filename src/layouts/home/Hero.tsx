                ...
                <div className="relative h-full max-w-7xl mx-auto">
                    ...
                    >
                        <defs>
                            ...
                            >
                                <rect x={0} y={0} width={4} height={4} className="text-red dark:text-red-light"
                                      fill="currentColor"/>
                            </pattern>
                        </defs>
                    ...
                    {({open}) => (
                        <>
                                    ...
                                    <div className="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                                        <div className="flex items-center justify-between w-full md:w-auto">
                                            ...
                                            <div className="-mr-2 flex items-center md:hidden">
                                                <Popover.Button
                                                    className="bg-blue-light rounded-md p-2 inline-flex items-center justify-center text-gray hover:text-blue hover:bg-gray-light focus:outline-none focus:ring-2 focus:ring-inset focus:ring-gray">
                            ...
                            >
                                ...
                                >
                                    <div
                                        className="rounded-lg shadow-md bg-white dark:bg-gray ring-1 ring-black ring-opacity-5 overflow-hidden">
                                        <div className="px-5 pt-4 flex items-center justify-between">
                                            ...
                                            <div className="-mr-2 px-2 pt-2">
                                                {p.themeButton}
                                                     <Popover.Button
                                                    className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray hover:text-red hover:bg-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red dark:bg-gray dark:text-white dark:hover:bg-white dark:hover:text-blue">
